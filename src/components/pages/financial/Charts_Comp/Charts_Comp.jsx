...
const ChartsComp = () => {
  ...
  // Global State
  const { areaData, annualEmployeePaymentTableData, earningDeductiobPieData, stackBarData, stackBarData2, pieRingData, dashboardLineData, dashboardMapData } = useContext(AppStoreContext);
    ...
    <h3>Analysis</h3>
      ...
      <div className="row">
        <div className="col-12">
          <PieChartComp data={ earningDeductiobPieData } chartTitle="GENDER" />
        </div>
      </div>

      <div className="row">
        <div className="col-12 col-lg-6">
        <AnnualEmployeePaymentComp tableData={ annualEmployeePaymentTableData } chartTitle="ANNUAL EMPLOYEE PAYMENT" />
        </div>
        <div className="col-12 col-lg-6">
